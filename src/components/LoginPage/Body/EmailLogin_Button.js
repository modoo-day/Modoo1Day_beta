    ...
    <View style={{flex: 1}}>
      <View style={{alignSelf: 'center', marginTop: -100}}>
        <Button
          ...
          <View style={{alignItems: 'center', flex: 1, flexDirection: 'row'}}>
            <View style={{marginRight: 26, marginLeft: 26}}>
              <Image
                source={require('../../../assets/icons/LocalLoginLogo.png')}
                style={{height: 45, width: 39}}
              />
            </View>
            <View style={{marginRight: 30}}>
              <Image
                source={require('../../../assets/icons/loginBorder.png')}
                style={{height: 62}}
              />
            </View>
            <Text
        ...
        <View style={{marginTop: 40, height: 40, alignItems: 'center'}}>
          <Text style={{fontFamily: 'neodgm', color: '#a7a7a7'}}>
